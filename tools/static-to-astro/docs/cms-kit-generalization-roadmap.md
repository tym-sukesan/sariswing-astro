...
**G-6-rls-audit（完了）:** [staging-rls-audit.md](./staging-rls-audit.md) — read-only RLS audit plan; `profile` / `admin_users` 主対象; `auditStatus: not_run`; policy/grant 変更なし; G-6-e implementation 前に必須レビュー。
