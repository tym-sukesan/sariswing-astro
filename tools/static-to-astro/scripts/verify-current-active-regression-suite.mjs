 ...
 *
 * Runs G-20u2–u14 + G-20u17–u22 site-aware active verifiers in sequence.
...
function main() {
  ...
  console.log(`\n${PHASE}`);
  console.log("Scope: G-20u2–u14 + G-20u17–u22 active verifiers · dry-run / module tests only");
