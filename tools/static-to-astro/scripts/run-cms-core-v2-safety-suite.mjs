...
const STEPS = [
  ...
  {
    id: "schedule-tbd-create-oneshot-success-result",
    kind: "node",
    script: "verify-cms-core-v2-schedule-tbd-create-oneshot-success-result.mjs",
  },
  {
    id: "schedule-tbd-create-oneshot-post-success-baseline",
    kind: "node",
  ...
  {
    id: "discography-site-owner-authz-planning",
    kind: "node",
  ...
  {
    id: "discography-site-owner-authz-slice-a-staging-apply-result",
    kind: "node",
    script: "verify-discography-site-owner-authz-slice-a-staging-apply-result.mjs",
  },
  {
    id: "discography-site-owner-authz-slice-a-edge-deploy-preflight",
    kind: "node",
  ...
  {
    id: "discography-site-owner-authz-slice-a-live-can-write-site-probe-planning",
    kind: "node",
    script: "verify-discography-site-owner-authz-slice-a-live-can-write-site-probe-planning.mjs",
  },
  {
    id: "discography-site-owner-authz-slice-a-live-can-write-site-probe-execution-preflight",
    kind: "node",
    script: "verify-discography-site-owner-authz-slice-a-live-can-write-site-probe-execution-preflight.mjs",
  },
  {
    id: "discography-site-owner-authz-slice-a-live-can-write-site-probe-final-hardening",
    kind: "node",
    script: "verify-discography-site-owner-authz-slice-a-live-can-write-site-probe-final-hardening.mjs",
  },
  {
    id: "discography-site-owner-authz-slice-a-live-can-write-site-probe-result",
    kind: "node",
  ...
  {
    id: "discography-site-owner-authz-slice-b-operational-save-preflight",
    kind: "node",
    script: "verify-discography-site-owner-authz-slice-b-operational-save-preflight.mjs",
  },
  {
    id: "discography-site-owner-authz-slice-b-operational-save-execution-packet-review",
    kind: "node",
    script: "verify-discography-site-owner-authz-slice-b-operational-save-execution-packet-review.mjs",
  },
  {
    id: "discography-site-owner-authz-slice-b-operational-save-execution-final-hardening",
    kind: "node",
    script: "verify-discography-site-owner-authz-slice-b-operational-save-execution-final-hardening.mjs",
  },
  {
    id: "discography-site-owner-authz-slice-b-version-50-secret-revision-investigation",
    kind: "node",
    script: "verify-discography-site-owner-authz-slice-b-version-50-secret-revision-investigation.mjs",
  },
  {
    id: "discography-site-owner-authz-slice-b-operational-save-version-guard-update",
    kind: "node",
    script: "verify-discography-site-owner-authz-slice-b-operational-save-version-guard-update.mjs",
  },
  {
    id: "discography-site-owner-authz-slice-b-operational-save-aborted-attempt-result",
    kind: "node",
    script: "verify-discography-site-owner-authz-slice-b-operational-save-aborted-attempt-result.mjs",
  },
  {
    id: "discography-site-owner-authz-slice-b-operational-save-aborted-attempt-2-result",
    kind: "node",
  ...
  {
    id: "discography-site-owner-authz-slice-b-operational-save-restoration-execution-result",
    kind: "node",
    script: "verify-discography-site-owner-authz-slice-b-operational-save-restoration-execution-result.mjs",
  },
  {
    id: "discography-site-owner-authz-slice-b-close",
    kind: "node",
    script: "verify-discography-site-owner-authz-slice-b-close.mjs",
  },
  {
