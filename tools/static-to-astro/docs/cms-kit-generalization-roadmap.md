...
**G-5y-e-b（完了）:** [private-server-side-allowlist-plan.md](./private-server-side-allowlist-plan.md) — private/server-side allowlist plan。実メール commit 禁止。browser allowlist は security boundary ではない。次: **G-5y-e-c** or **G-5z-a**。
