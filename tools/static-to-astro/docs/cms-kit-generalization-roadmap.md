...
**G-6-e1-schedule-schema-read-audit（完了）:** [schedule-schema-read-audit.md](./schedule-schema-read-audit.md) — read-only `schedules` / `schedule_months` audit plan; manual SQL required; 次: G-6-e1-schedule-schema-read-audit-result.
