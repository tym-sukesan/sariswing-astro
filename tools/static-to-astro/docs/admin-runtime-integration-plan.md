...
| **G-6-e2-schedule-dry-run-ui-planning（完了）** | [Dry-run UI planning](./schedule-dry-run-ui-planning.md) | Update + duplicate dry-run; next: scaffold |
| **G-6-e** | Schedule write (staging) | Blocked — scaffold + write phases + approval |
