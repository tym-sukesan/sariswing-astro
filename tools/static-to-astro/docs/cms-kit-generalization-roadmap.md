...
**G-5y-e-a（完了）:** [staging-role-allowlist-mock.md](./staging-role-allowlist-mock.md) — mock allowlist / role resolver / permission status。`admin_users`/DB/RLS 未使用。次: **G-5y-e-b** or **G-5z**。
