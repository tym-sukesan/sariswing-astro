...
NEXT_RECOMMENDED: cms-core-v2-schedule-tbd-admin-ui-connect
```

Follow-up (current Kit Primary): Schedule TBD read-wiring COMPLETE · next Admin UI / Save dry-run · then Mio seed regen. Contact HubSpot COMPLETE WITH NON-BLOCKING (submit E2E recheck).
