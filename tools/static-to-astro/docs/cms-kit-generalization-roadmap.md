...
**G-6-c（完了）:** [disabled-write-action-scaffold.md](./disabled-write-action-scaffold.md) — UI scaffold only; all write actions disabled; `readyForG6DPlanning: true`。次: **G-6-d** staging profile update PoC planning / approval。
