...
**Status:** G-5a〜**G-5r（prototype preview harness）** 完了 — G-5s 以降は段階的に  
...
| **G-5s** | Site-config driven admin scaffold generator | generator |
| **G-5t** | Runtime integration plan | doc |
| **G-5u** | Local-only preview route | route |
| **G-5v** | Customer demo package | package |
