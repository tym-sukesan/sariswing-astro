...
registrySiteEmbedsStillFalse: false
...
| Item | Result |
| --- | --- |
| Change | `gosaki-piano.supabaseFeatures.siteEmbeds` **false → true** |
...
| Item | Result |
| --- | --- |
| Env | `CMS_KIT_SITE_EMBEDS_BUILD_READ=true` + Admin path ON · Save arms false |
