...
assert("hub has mio class", /mio-schedule-hub/.test(hub));
...
assert("aug has booking", /mio-schedule-event__booking/.test(aug));
...
assert("aug has long title class", /mio-schedule-event--long-title/.test(aug));
