...
**G-6-e1-schedule-schema-read-audit-result（完了）:** [schedule-schema-read-audit-result.md](./schedule-schema-read-audit-result.md) — MVP schema compatible; `schedule_months` derived/read model; 次: G-6-e2-schedule-dry-run-ui-planning.
