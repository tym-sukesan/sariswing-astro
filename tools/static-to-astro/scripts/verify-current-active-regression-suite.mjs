...
export const HISTORICAL_VERIFIERS = [
  ...
  { id: "G-20u35", label: "Gosaki Discography staging DB write test plan & rollback drill", script: "verify-g20u35-gosaki-discography-staging-db-write-test-plan-rollback-drill.mjs" },
  ...
  { id: "G-20u36a-permissions-remediation-plan", label: "Gosaki Discography permissions remediation plan", script: "verify-g20u36a-permissions-remediation-plan.mjs" },
  ...
  { id: "G-20u36a-permissions-remediation-after-verification", label: "Gosaki Discography permissions remediation after-verification SELECT-only", script: "verify-g20u36a-permissions-remediation-after-verification.mjs" },
  ...
  { id: "G-20u36b-preflight", label: "Gosaki Discography Edge dry-run endpoint deploy preflight", script: "verify-g20u36b-edge-dry-run-endpoint-deploy-preflight.mjs" },
  { id: "G-20u36b-preflight-result", label: "Gosaki Discography Edge dry-run endpoint deploy preflight result record", script: "verify-g20u36b-result-gosaki-discography-edge-dry-run-endpoint-deploy-preflight-result.mjs" },
  { id: "G-20u36b-deploy-manual-plan", label: "Gosaki Discography Edge dry-run endpoint deploy manual plan", script: "verify-g20u36b-edge-dry-run-endpoint-deploy-manual-plan.mjs" },
  { id: "G-20u36b-function-source-staging", label: "Gosaki Discography Edge dry-run endpoint function source staging", script: "verify-g20u36b-edge-dry-run-endpoint-function-source-staging.mjs" },
  { id: "G-20u36b-root-placement-plan", label: "Gosaki Discography Edge dry-run endpoint root placement plan", script: "verify-g20u36b-edge-dry-run-endpoint-root-placement-plan.mjs" },
];
