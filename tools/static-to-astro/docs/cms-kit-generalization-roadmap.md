...
**G-6-e2-schedule-dry-run-ui-planning（完了）:** [schedule-dry-run-ui-planning.md](./schedule-dry-run-ui-planning.md) — update + duplicate dry-run UI; 次: G-6-e2-schedule-dry-run-ui-scaffold.
