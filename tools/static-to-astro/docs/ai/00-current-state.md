...
**CMS Core v2 admin staging-ref assert helper (2026-07-29):** **COMPLETE** — Doc: `cms-core-v2-admin-staging-ref-assert-helper.md` · Core SoT `supabase-staging-ref-utils.mjs` · YouTube/About/Schedule/Discography Node wrappers + package/admin-env constants · **Edge/Deno/Admin UI not wired** · **CLIENT_SHARE_READY maintained** · package **`dc1c5b6…` unchanged** · Gate: `CMS_CORE_V2_ADMIN_STAGING_REF_ASSERT_HELPER_COMPLETE: true` · **Next:** arm-parse policy note（docs）· Edge staging-ref は別 phase · 並行: client staging share.
