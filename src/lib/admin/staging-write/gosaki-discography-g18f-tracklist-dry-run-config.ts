/**
 * G-18f — Tracklist textarea diff dry-run config (Save always disabled).
 */
...
export const G18F_TRACKLIST_SAVE_DISABLED_REASON =
  "G-18f tracklist textarea diff — Save disabled; dry-run Preview only.";

export const G18F_TRACKLIST_DRY_RUN_PREVIEW_ENABLED = true as const;

export const G18F_TRACKLIST_SAVE_ENABLED = false as const;

export interface GosakiDiscographyG18fTracklistDryRunConfig {
  ...
  defaultDisabledReason: typeof G18F_TRACKLIST_SAVE_DISABLED_REASON;
  dryRun: boolean;
...
export function getGosakiDiscographyG18fTracklistDryRunConfig(
  env: ImportMetaEnv = import.meta.env,
): GosakiDiscographyG18fTracklistDryRunConfig {
  ...
  return {
    ...
    tracklistPreviewEnabled: G18F_TRACKLIST_DRY_RUN_PREVIEW_ENABLED,
    saveEnabled: G18F_TRACKLIST_SAVE_ENABLED,
    dbWriteEnabled: false,
    defaultDisabledReason: G18F_TRACKLIST_SAVE_DISABLED_REASON,
    dryRun,
