/**
 * G-12a — Gosaki About content Save (GitHub Contents PUT · No workflow_dispatch).
 */
import "jsr:@supabase/functions-js/edge-runtime.d.ts";
import { corsHeaders, jsonResponse, requireAdminUser } from "../_shared/admin-auth.ts";
import { handleG12aAboutContentSaveBody } from "../_shared/gosaki-about-content-save.ts";
...
Deno.serve(async (req) => {
  ...
  const result = await handleG12aAboutContentSaveBody(body);
