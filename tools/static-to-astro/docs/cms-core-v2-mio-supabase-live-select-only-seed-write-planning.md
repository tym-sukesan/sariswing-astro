...
- **Helpers:** `cms-core-v2-schedule-tbd-date-contract-helpers` **COMPLETE** (offline pure helpers · Mio `mio-sched-2026-09-01` proof · runtime/schema/seed SQL still unconnected)
...
NEXT_AFTER_BLOCKER: cms-core-v2-schedule-tbd-date-gosaki-read-compat → migration → seed regen/apply
