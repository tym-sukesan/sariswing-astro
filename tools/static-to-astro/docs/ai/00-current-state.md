...
2. Current phase
現在フェーズ: **G-9g4a2a2-open-time-only-operational-expansion-manual-execution**（G-9g4a2a1 preflight 完了後 — manual execution 未着手）

G-9g4a2a1: Schedule open_time-only operational expansion **preflight complete**（uncommitted）。target row `eb1f1898-5107-4deb-a6d5-a792e0ec3f69`; open_time smoke `11:30 [G-9g4a2a open_time smoke]`; restore `11:30`; lock `2026-06-19T05:54:34.767498+00:00`. No Preview / Save / DB write / SQL in preflight phase.
...
Git: 最新 push 済み commit `8ae0d1e`（G-9g4a2a implementation）。G-9g4a2a1 preflight **uncommitted**。
...
次フェーズ推奨: **G-9g4a2a2-open-time-only-operational-expansion-manual-execution**

G-9g4a2a1 Schedule open_time-only operational expansion **preflight complete**（uncommitted）。target `eb1f1898-5107-4deb-a6d5-a792e0ec3f69` / `schedule-2026-03-003`; before `open_time` `11:30`; candidate `11:30 [G-9g4a2a open_time smoke]`; restore `11:30`; `expectedBeforeUpdatedAt` `2026-06-19T05:54:34.767498+00:00`. No Preview / Save / DB write in preflight phase.
...
Phase sequence:
```txt
G-9g4a2a-open-time-only-operational-expansion-implementation ← complete (8ae0d1e)
G-9g4a2a1-open-time-only-operational-expansion-preflight ← complete (uncommitted)
G-9g4a2a2-open-time-only-operational-expansion-manual-execution ← next
```
...
Routine dev: dry-run on / all non-dry-run arms off including G-9g4a2a. Do not re-click G-9g4a1 venue-only Save or G-9g4a2a open_time-only Save.
