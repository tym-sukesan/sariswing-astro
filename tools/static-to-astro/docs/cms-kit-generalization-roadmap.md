...
**G-5y-c（完了）:** [staging-login-ui-shell.md](./staging-login-ui-shell.md) — login UI shell / forgot-password UI / route guard planned。real auth disabled。次: **G-5y-d** staging Supabase Auth connection。
