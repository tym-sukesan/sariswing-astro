...
**G-5g（完了）:** [`generate-site-dry-run.mjs`](../scripts/generate-site-dry-run.mjs) が plan から schema skeleton / seed skeleton / storage tasks を出力。詳細: [site-generation-dry-run.md](./site-generation-dry-run.md)
