...
**G-6-rls-audit-result（完了）:** [staging-rls-audit-result.md](./staging-rls-audit-result.md) — manual SQL collected; profile mostly OK; TRUNCATE/TRIGGER/REFERENCES grants too broad; 次: G-6-rls-grant-cleanup-plan; `readyForG6EImplementation: false`.
