...
**G-6-d-blocker（完了）:** [profile-schema-alignment-plan.md](./profile-schema-alignment-plan.md) — `public.profile` missing on staging; recommended dedicated `public.profile`; non-dry-run blocked。次: G-6-d-schema-apply-prep。
