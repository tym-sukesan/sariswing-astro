...
| **G-5w-b（完了）** | [Writer dry-run CLI](./admin-scaffold-writer-dry-run-cli.md) — consumes G-5s package |
...
- [admin-scaffold-writer-plan.md](./admin-scaffold-writer-plan.md) — **G-5w-a** explicit opt-in writer plan
- [admin-scaffold-writer-dry-run-cli.md](./admin-scaffold-writer-dry-run-cli.md) — **G-5w-b** writer dry-run CLI (consumes G-5s package)
