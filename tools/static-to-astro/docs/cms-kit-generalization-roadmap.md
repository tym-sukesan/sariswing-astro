...
**G-6-e3-schedule-dry-run-adapter-planning（完了）:** [schedule-dry-run-adapter-planning.md](./schedule-dry-run-adapter-planning.md) — dry-run adapter boundary; pure functions; 次: G-6-e3-schedule-dry-run-adapter-implementation.
