...
**Status:** G-5a〜**G-5n（Admin Media upload scaffold）** 完了 — G-5o 以降は段階的に  
...
- [admin-media-upload-abstraction.md](./admin-media-upload-abstraction.md) — **G-5n** Admin Media upload abstraction
...
**G-5n（完了）:** [admin-media-upload-abstraction.md](./admin-media-upload-abstraction.md) — Media upload UI + storageMappings policy。Supabase Storage 未接続。次: **G-5o** Publish workflow。
