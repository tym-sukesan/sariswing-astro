...
**G-6-d-auth-session-display-investigation（完了）:** [staging-auth-session-display-investigation.md](./staging-auth-session-display-investigation.md) — Auth表示調査; debug panel; non-dry-run ブロック継続。
