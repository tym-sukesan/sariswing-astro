...
**G-6-d-verify（完了）:** [staging-profile-update-poc-verification-checklist.md](./staging-profile-update-poc-verification-checklist.md) — first non-dry-run未実行; manual write checklist ready。次: user-approved manual first staging write only。
