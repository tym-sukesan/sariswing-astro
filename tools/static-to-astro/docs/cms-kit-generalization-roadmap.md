...
**G-6-d（完了）:** [staging-profile-update-poc-implementation.md](./staging-profile-update-poc-implementation.md) — gated profile update PoC; default disabled; dry-run default; `/admin` disconnected。次: G-6-e（別approval）。
