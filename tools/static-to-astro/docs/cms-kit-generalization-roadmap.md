...
**G-6-e4-schedule-write-adapter-planning（完了）:** [schedule-write-adapter-planning.md](./schedule-write-adapter-planning.md) — real write adapter boundary; update-only first PoC; planning only; 次: G-6-e4-schedule-write-adapter-implementation-planning.
