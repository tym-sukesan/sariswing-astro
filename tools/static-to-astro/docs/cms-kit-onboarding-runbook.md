...
| Phase | 内容 |
| --- | --- |
| **G-5i** | Admin CMS template extraction / module 分岐 |
| **G-5j** | customer-facing onboarding checklist（非エンジニア向け） |
| **G-5k** | pricing / subscription model draft |
| **G-5l** | production migration runbook |
