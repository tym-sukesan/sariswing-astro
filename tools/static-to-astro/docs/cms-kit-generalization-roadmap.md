...
**Status:** G-5a〜**G-5m-a（Admin CRUD UI scaffold）** 完了 — G-5m-b / G-5n 以降は段階的に  
...
**G-5m-a（完了）:** [admin-crud-ui-scaffold.md](./admin-crud-ui-scaffold.md) — 9 CRUD / module scaffolds。Supabase / Auth / Storage 未接続。次: **G-5m-b** Auth または **G-5n** Media。
