...
**G-5y-d-prep（完了）:** [supabase-auth-staging-connection-checklist.md](./supabase-auth-staging-connection-checklist.md) — project / redirect / env / allowlist / rollback preflight。Auth 実接続なし。次: **G-5y-d** staging Supabase Auth connection（explicit approval）。
