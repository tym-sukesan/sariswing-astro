...
**G-5z-f（完了）:** [customer-demo-package-before-writes/README.md](./customer-demo-package-before-writes/README.md) — `readyForCustomerDemo: true`。次: **G-6-a** または onboarding / pricing。
