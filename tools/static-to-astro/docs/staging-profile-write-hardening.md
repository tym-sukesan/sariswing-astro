...
**G-6-rls-audit-result（完了）:** [staging-rls-audit-result.md](./staging-rls-audit-result.md) — manual SQL collected; profile mostly OK; broad TRUNCATE/TRIGGER/REFERENCES grants.
