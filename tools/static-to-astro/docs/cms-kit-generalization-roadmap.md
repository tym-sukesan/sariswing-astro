...
**G-6-e4-schedule-update-grant-prep（完了）:** [schedule-update-grant-prep.md](./schedule-update-grant-prep.md) — `authenticated UPDATE` grant prep; GRANT not executed; 次: G-6-e4-schedule-update-grant-manual-apply-prep.
