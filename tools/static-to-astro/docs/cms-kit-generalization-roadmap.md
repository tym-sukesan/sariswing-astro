...
**G-6-d-schema-apply-prep（完了）:** [profile-schema-apply-prep.md](./profile-schema-apply-prep.md) — manual SQL package; `admin_users` without `is_active`。次: G-6-d-schema-apply（ユーザー手動）。
