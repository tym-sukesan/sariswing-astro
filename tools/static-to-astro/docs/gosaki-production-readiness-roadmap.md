...
Phase 3-Y: gosaki readiness verifier（完了）
Phase G-2b: staging FTP apply 実接続（未実施 — 3-Y PASS 後）
...
- `verify-gosaki-readiness.mjs` で convert / export / build / static-public / deploy dry-run / CMS loop 等を一括検証
- 成果物: [gosaki-readiness-verifier.md](./gosaki-readiness-verifier.md)
- G-2b 条件: `READY_FOR_STAGING_FTP_APPLY: yes`
...
| [gosaki-readiness-verifier.md](./gosaki-readiness-verifier.md) | G-2b 前ゲート（3-Y） |
