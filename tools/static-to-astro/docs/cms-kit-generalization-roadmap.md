...
**G-5y-b（完了）:** [admin-auth-adapter-scaffold.md](./admin-auth-adapter-scaffold.md) — Auth adapter scaffold / mock provider / dry-run CLI。staging shell に Auth mock status 表示。次: **G-5y-c** staging login UI shell。
