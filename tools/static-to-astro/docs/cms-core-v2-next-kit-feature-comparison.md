...
**Next safe gate:** operator re-accepted RLS · **`readyForOperatorAboutRlsApply: true`** · migration gate **false** · RLS → seed · Doc: `cms-core-v2-about-supabase-vertical-slice-apply-readiness.md`.
